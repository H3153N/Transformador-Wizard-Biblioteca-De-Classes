...
namespace Biblioteca
{
    ...
    {
        public static string EndereçoGeradorLAN { get; set; } = "TCPIP::192.168.0.100::INSTR";
        public static string EndereçoOsciloscopioLAN { get; set; } = "TCPIP::192.168.0.101::INSTR";
        ...
        public static void AjustarEscalaVerticalTensão(double tensãoDePicoVindaDoGerador, Canal canalDaTensão, int numeroIterações)
        {
        ...
        public static string AlterarSinalDoGerador(string formaDeOnda, double frequencia, double amplitude, double offset, bool ativarSaida)
        {
            ...
            {
                return "AlterarSinalDoGerador: conexão é null";
            }
        ...
        public static string SetEscalaDeTempo()
        {
            ...
            {
                return "SetEscalaDeTempo: conexão é null";
            }
        }
        ...
        public static double GetTensãoDePicoMedida(Canal fonteDoSinal)
        {
            if (ConexãoOsciloscópio != null)
            {
